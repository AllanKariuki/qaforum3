...
<form class="well w3-white">
	<input type="hidden" id="sender_id" value="<?php echo $sender_id;?>">
	<input type="hidden" id="replier_id" value="<?php echo $replier_id;?>">
	<input type="hidden" id="question_id" value="<?php echo $question_id; ?>"><br>
	...
	<button class="btn btn-default btn-sm" style="border-color: #46b8da; color: #46b8da;" id="reply_btn">Post your Reply</button>&nbsp
